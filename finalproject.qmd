...
server<-function(input, output, session){
  ...
  disclaimer <- "Temp and Wind calculators are based on the maxiumum value of wind speed and temperature selected in the sliders. There is not as prevalent of data for high wind speeds and temperatures, which could result in inaccurate predictions."
